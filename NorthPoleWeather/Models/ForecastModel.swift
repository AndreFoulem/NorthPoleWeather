...
extension Forecast {
  ...
  static let hourly: [Forecast] = [
    ...
    Forecast(date: .init(timeIntervalSinceNow: hour * 2), weather: .rainy, probability: 15, temperature: 18, high: 24, low: 18, location: "Montreal, Canada"),
    Forecast(date: .init(timeIntervalSinceNow: hour * 3), weather: .rainy, probability: 20, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
    Forecast(date: .init(timeIntervalSinceNow: hour * 4), weather: .rainy, probability: 50, temperature: 19, high: 24, low: 18, location: "Montreal, Canada")
  ]
  ...
  static let weekly: [Forecast] = [
    ...
    Forecast(date: .init(timeIntervalSinceNow: day * 1), weather: .rainy, probability: 10, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
    ...
    Forecast(date: .init(timeIntervalSinceNow: day * 4), weather: .rainy, probability: 70, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
    Forecast(date: .init(timeIntervalSinceNow: day * 5), weather: .rainy, probability: 90, temperature: 19, high: 24, low: 18, location: "Montreal, Canada")
  ]
  
  static let cities: [Forecast] = [
    Forecast(date: .now, weather: .rainy, probability: 10, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
